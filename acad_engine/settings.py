...
Note:
The entire assessment flow is secured using token-based authentication. Students are strictly restricted to accessing only their own exams, submissions, and results.
